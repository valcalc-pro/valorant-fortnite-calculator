...
function calculate() {
    const prices = { select: 5, deluxe: 8, premium: 12, exclusive: 20, ultra: 30, bp: 1.5, vp_rate: 0.008 };
...
function shareResults() { alert("Link copied!"); }
